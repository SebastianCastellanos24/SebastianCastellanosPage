...
export const HomeStudys = () => {
  return (
    <div className="App grid lg:grid-cols-2 lg:gap-4 mb-16">
      ...
      <div className="flex flex-col bg-[#F5F9FF] p-5 rounded drop-shadow-xl justify-center items-center text-[#0D378C] md:flex-row hover:scale-110 ease-in hover:z-10">
        <div className="px-3">
          <img className="w-20" src={Udemy} alt="udemy log" />
        </div>
        <div className="px-2 mt-7 md:px-5 md:mt-0">
